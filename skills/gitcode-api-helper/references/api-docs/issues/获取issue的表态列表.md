...
**方法:** `GET`
**端点:** `https://api.gitcode.com/api/v5/repos/:owner/:repo/issues/:number/user_reactions`
...
conn.request("GET", "/api/v5/repos/:owner/:repo/issues/:number/user_reactions", payload, headers)
